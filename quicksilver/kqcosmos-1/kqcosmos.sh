...
echo "░  ░  ░   ░    ░    ░ ░   ░      ░      ░   ░ ░   ░   ░ ░        ";
echo "      ░   ░    ░      ░  ░       ░            ░     ░          ░ ";
echo "           Auto Installer kqcosmos-1 For killerqueen             ";
echo -e "\e[0m"
sleep 2

# Set Vars
if [ ! $NODENAME ]; then
	read -p "root@sxlmnwb:~# [ENTER YOUR NODE] > " NODENAME
...
echo ""
echo -e "Check Running Logs: \e[1m\e[31mjournalctl -u icad -f -o cat\e[0m"
# End
