...
HEART_GENESIS=https://snapshots.polkachu.com/testnet-genesis/humans/genesis.json
...
wget $HEART_GENESIS -O $HOME/$HEART_FOLDER/config/genesis.json
...
sed -i -e "s|^seeds *=.*|seeds = \"$SEEDS\"|" $HOME/$HEART_FOLDER/config/config.toml
